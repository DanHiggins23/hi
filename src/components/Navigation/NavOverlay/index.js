            ...
            <div className="overlay__content">
                ...
                <ul className="overlay__nav">
                    <li className="overlay__nav-item">
                        <Link className="overlay__nav-link" to="/bt" onClick={props.buttonClick}>BT</Link>
                    </li>
                    <li className="overlay__nav-item">
                        <Link className="overlay__nav-link" to="/ford" onClick={props.buttonClick}>FORD</Link>
                    </li>
                    <li className="overlay__nav-item">
                        <Link className="overlay__nav-link" to="/santander" onClick={props.buttonClick}>SANTANDER</Link>
                    </li>
                </ul>
